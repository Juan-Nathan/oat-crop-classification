...
- **Tuned RF with SMOTE** provided the **best overall balance** with the highest accuracy and F1-score among the three. In contrast, **ANN with SMOTE** was better for **maximizing the identification of oat crops**, achieving the highest recall while still providing acceptable discrimination between classes with a fair AUC.
